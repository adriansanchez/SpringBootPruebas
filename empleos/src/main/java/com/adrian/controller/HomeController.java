...
public class HomeController {
	...
	public String mostrarListado(Model model) {
		...
		listas.add("Ingeniero de sistemas");
		listas.add("Auxiliar de contabilidad");
		listas.add("Vendedor");
		listas.add("Arquitecto");
		model.addAttribute("empleos",listas);
		return "listado";
...
//		model.addAttribute("fecha",new Date());
	...
	private List<Vacante> getVacantes(){
		...
		try {
			...
			vacante3.setDescripcion("Empresa internacional solicita ingeniero mecanico para mantimiento de instalación electrica");
			...
			vacante4.setDescripcion("Solicitamos diseñador grafico titulado para diseño de publicidad de la empresa");
